...
class WTTArmoryAuto5 {
    ...
    displayCreditBanner() {
        ...
        this.Instance.logger.log(`[${this.modName}] Barrel reciprocation in...3...2...1`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] ------------------------------------------------------------------------`, LogTextColor_1.LogTextColor.GREEN);
    }
}
module.exports = { mod: new WTTArmoryAuto5() };
